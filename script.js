...
// Adicione descrições das personalidades
const descriptions = {
  fleumatico: "Você é calmo, pacífico e confiável. Prefere evitar conflitos e gosta de ambientes harmoniosos.",
  melancolico: "Você é perfeccionista, analítico e introspectivo. Gosta de planejar tudo com detalhes e aprecia a organização.",
  sanguineo: "Você é extrovertido, otimista e entusiasmado. Adora estar com pessoas, socializar e animar os outros.",
  colerico: "Você é determinado, enérgico e focado. Possui habilidades de liderança e prefere tomar decisões rapidamente."
};
...
function showResult() {
  ...
  descriptionElement.textContent = temperament
